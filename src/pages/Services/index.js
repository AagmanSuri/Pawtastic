...
const alignStyle = {textAlign:"center", fontSize: "20px", color: "black", backgroundColor: "#f7eceb" };
...
const index = () => {
  ...
  <>  
    ...
    <button style={{ color: "white", backgroundColor: "#545871", marginLeft: "175px" }}
    className="btn">
      Take a Walk!
    </button>
    </Link>
    <Link to="/Services/Visit">
    <button style={{ color: "white", backgroundColor: "#545871", marginLeft: "375px" }}
    className="btn">
      Come Visit!
    </button>
    </Link>
